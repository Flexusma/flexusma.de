<template>
  <card-container class="bg-white p-8">
    <div class="text-3xl font-semibold mb-6">Impressum</div>
    ...
    <p><strong>Kontakt:</strong> <br>
      E-Mail: <a>info [at] flexusma [punkt] de</a><br></p>

    <p><strong class="text-xl mt-8">Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>
