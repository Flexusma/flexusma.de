<template>
  <card-container class="bg-white p-8">
    <div class="text-3xl mb-6 font-semibold">Datenschutz&shy;erkl&auml;rung</div>
    ...
    <p>Diese Website wird nicht gehostet. Die personenbezogenen Daten, die auf dieser Website erfasst werden, werden
    ...
    <p>Das Hosting erfolgt zum Zwecke der Vertragserf&uuml;llung gegen&uuml;ber unseren potenziellen und
    ...
    <p>akazia.eu (gleich des Anbieters dieser Website)</p>
    ...
    <p>
      E-Mail: info [at] flexusma [punkt] de</p>
    ...
    <p>Sofern Sie in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen Daten auf
      ...
      Abs. 1 lit. a DSGVO. Sofern Sie in die Speicherung von Cookies oder in den Zugriff auf Informationen in Ihr Endger&auml;t
      (z.&nbsp;B. via Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zus&auml;tzlich auf
      Grundlage von &sect; 25 Abs. 1 TTDSG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserf&uuml;llung
  ...
  <card-container id="contact" class="backdrop-blur-md relative p-8 flex-grow tracking-tight my-6">
    <img src="../assets/logo_3d_bgm.png"
         class="object-cover absolute  -z-20 top-0 bottom-0 left-0 right-0 h-full w-full blur-2xl bg-gray-200">
    ...
    <div class="text-lg text-gray-700 my-10">
      ...
      <div>Feel free to message me on Matrix <span
          class="font-mono rounded-lg bg-white bg-opacity-10 backdrop-hue-rotate-15 text-black px-1.5 py-0.5">@flexusma:im.m4fx.de</span>
      </div>
    </div>
    <div class="flex space-y-4 sm:space-y-0 sm:space-x-4 flex-col sm:flex-row">
      <div class="flex items-center justify-center sm:justify-start space-x-4">
        <a href="https://dribbble.com/flexusma" target="_blank"
           class="transition-all duration-500 bg-white p-2 rounded-xl shadow hover:bg-pink-600 hover:text-white cursor-pointer grow-0 flex items-center justify-center w-12 h-12">
          <i class="mdi mdi-basketball text-2xl"></i>
        </a>
        <a href="https://discord.gg/Tkn3asxZyp" target="_blank"
           class="transition-all duration-500 bg-white p-2 rounded-xl shadow hover:bg-blue-600 hover:text-white cursor-pointer grow-0 flex items-center justify-center w-12 h-12">
          <i class="mdi mdi-forum text-2xl"></i>
        </a>
        <a href="mailto:info@flexusma.de" target="_blank"
           class="transition-all duration-500 bg-white p-2 rounded-xl shadow hover:bg-emerald-600 hover:text-white cursor-pointer grow-0 flex items-center justify-center w-12 h-12">
